...
import { GestionComponent } from 'app/entities/gestion/gestion.component';
...
describe('Component Tests', () => {
  describe('Gestion Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gestions && comp.gestions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
